...
const Footer = () => {
  return (
    <footer className="py-16 bg-gray-200"> {/* Changed background color to a lighter gray */}
      <motion.div
        initial={{ opacity: 0, y: 50 }}
        whileInView={{ opacity: 1, y: 0 }}
        className="container"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-14 md:gap-4">
          {/* first section */}
          <div className="space-y-4 max-w-[300px]">
            <h1 className="text-3xl font-bold text-black">Your Trusted Marketplace</h1> {/* Changed heading color to black */}
            <p className="text-gray-800 text-lg"> {/* Changed text color to dark gray for better contrast */}
              Our platform connects you with reliable service providers across various fields. 
              Experience seamless service access, personalized recommendations, and multi-language support.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-10">
            <div className="space-y-4">
              <h1 className="text-2xl font-bold text-black">Services</h1> {/* Changed heading color to black */}
              <div className="text-gray-800"> {/* Changed text color to dark gray */}
                <ul className="space-y-2 text-lg">
            ...
            <div className="space-y-4">
              <h1 className="text-2xl font-bold text-black">Quick Links</h1> {/* Changed heading color to black */}
              <div className="text-gray-800"> {/* Changed text color to dark gray */}
                <ul className="space-y-2 text-lg">
          ...
          {/* third section */}
          <div className="space-y-4 max-w-[300px]">
            <h1 className="text-2xl font-bold text-black">Stay Connected</h1> {/* Changed heading color to black */}
            <div className="flex items-center">
              <input
                type="text"
                placeholder="Enter your email"
