...
const NavbarMenu = [
  ...
  { id: 2, title: "Services", path: "services" }, // Link to Services section
  { id: 3, title: "Banner", path: "banner" },     // Link to Banner section
  { id: 4, title: "Banner3", path: "banner3" },   // Link to Banner3 section
